...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Frunkin' on a Friday Night",	"Play on a Friday... Night.",						'friday_night_play',	 true],
		["She Calls Me Daddy Too",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["No More Tricks or Treats",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Who's the better hitman",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
		["Demon hunter",					"Beat Week 4 on Hard with no Misses.",				'week4_nomiss',			false],
		["Missless Holidays",			"Beat Week 5 on Hard with no Misses.",				'week5_nomiss',			false],
